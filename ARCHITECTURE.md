# 🩺 Skin Disease Detection & LLM Advisor — Architecture Documentation
...
The **Skin Disease Detection & LLM Advisor System** is an AI-powered medical imaging application that combines a **Convolutional Neural Network (CNN)** for skin disease classification with a **Large Language Model (LLM)** to generate patient-friendly recommendations. Users upload a skin image through a Gradio web interface; the system classifies it into one of **10 dermatological conditions** and returns structured medical advice powered by **Google Gemini Flash**.
...
### 6.1 ResNet50 with Custom Classification Head
...
### 8.2 POST /analyze_skin — Full Contract
